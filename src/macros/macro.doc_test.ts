...
Deno.test("Macro demo", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "                      6",
        '                      7     {{ aMacro(1024); }}',
        "000000 E0 91 00 04    7     LDS R30, address",
        "                      8",
        '                      9     {{ aMacro(2048); }}',
        "000002 E0 91 00 08    9     LDS R30, address",
        "",
        "Symbol Table",
        "============",
        "",
...
Deno.test("Playing back multiple copies of a macro with JS", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "000000 E0 91 00 04    7     LDS R30, address",
        "000002 E0 91 00 08    7     LDS R30, address",
        "",
        "Symbol Table",
        "============",
        "",
...
Deno.test("A macro can be called from inside another macro", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "                     12     {{ outerMacro() }}",
        "                     12     {{ innerMacro(1024); }}",
        "000000 E0 91 00 04   12     LDS R30, address",
        "                     12     {{ innerMacro(2048); }}",
        "000002 E0 91 00 08   12     LDS R30, address",
        "",
        "Symbol Table",
        "============",
        "",
...
Deno.test("A macro can be defined in one file and used in another", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "=================",
        "                      3     {{ aMacro(1024); }}",
        "000000 E0 91 00 04    3     LDS R30, address",
        "",
        "Symbol Table",
        "============",
        "",
