...
Deno.test("serial-send Demo", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "                     62",
        "                     63 the_top:",
        "000016 E5 E0         64     ldi ZL, low(characters_to_send << 1)",
        ...
        "00001E CF FD         77     rjmp wait_for_20ms_interval",
        "                     78",
        "                     79 get_next_character:",
        "00001F 91 35         80     lpm R19, Z+",
        '000020 32 30         81     cpi R19, " ".charCodeAt(0)',
        "000021 F3 A1         82     breq the_top",
        "                     83",
        "                     84 write_serial:",
        "000022 23 33         85     tst R19",
        "000023 F3 A1         86     breq send_character",
        "                     87",
        "                     88 buffer_wait:",
        "000024 9B 5D         89     sbis UCSRA, UDRE",
        "000025 CF FE         90     rjmp buffer_wait",
        "                     91",
        "000026 B9 3C         92     out    UDR, R19",
        "                     93",
        "000027 CF F0         94     rjmp send_character",
        "                     95",
        "                     96 characters_to_send:",
        '000028 54 65 73 74   97     {{ poke ("Testing1234 "); }}',
        "00002A 69 6E 67 31",
        "00002C 32 33 34 20",
        "                     98",
        "",
        ...
        "buffer_wait            | 36   | 24  | /var/tmp/demo.asm:88 | 1",
        "characters_to_send     | 40   | 28  | /var/tmp/demo.asm:96 | 0",
        ...
        "write_serial           | 34   | 22  | /var/tmp/demo.asm:84 | 0",
        "ZH                     |      |     | REGISTER             | 1",
        "ZL                     |      |     | REGISTER             | 1"
    ]);
});
