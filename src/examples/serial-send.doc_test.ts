...
Deno.test("serial-send Demo", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "                     64",
        "                     65 the_top:",
        "000018 E4 E8         66     ldi ZL, low(digits_to_send << 1)",
        ...
        "                     80",
        "                     81 get_next_char:",
        "000020 91 45         82     lpm R20, Z+",
        '000021 32 40         83     cpi R20, " ".charCodeAt(0)',
        "                     84     breq the_top",
        "                        mnemonic_unknown",
        "                        clue: BREQ",
        "                     85",
        "                     86 write_serial:",
        "000022 23 44         87     tst R20",
        "                     88     breq send_digit",
        "                        mnemonic_unknown",
        "                        clue: BREQ",
        "                     89",
        ...
        "                     97",
        "                     98 digits_to_send:",
        '000024 54 65 73 74   99     {{ poke ("Testing1234 "); }}',
        "000026 69 6E 67 31",
        "000028 32 33 34 20",
        "                    100",
        "",
        ...
        "buffer_wait            | 35   | 23  | /var/tmp/demo.asm:90 | 1",
        ...
        "digits_to_send         | 36   | 24  | /var/tmp/demo.asm:98 | 0",
        ...
        "write_serial           | 34   | 22  | /var/tmp/demo.asm:86 | 0",
        "ZH                     |      |     | REGISTER             | 1",
        "ZL                     |      |     | REGISTER             | 1"
    ]);
});
