...
Deno.test("serial-send Demo", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "                      6",
        "                      7 setup_timer:",
        "000003 BC 0F          8     out TCCR1A, R0",
        "                      9",
        "                     10     ldi R18, (1 << CS12)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "000004 BD 2E         11     out TCCR1B, R18",
        "                     12",
        "                     13     ldi R18, high(1152)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "000005 BD 2B         14     out OCR1AH, R18",
        "                     15     ldi R18, low(1152)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "000006 BD 2A         16     out OCR1AL, R18",
        "                     17",
        "                     18 start_interval_timers:",
        "000007 BC 0D         19     out TCNT1H, R0",
        "000008 BC 0C         20     out TCNT1L, R0",
        "                     21",
        "                     22     ldi R18, (1 << OCF1A) | (1 << OCF1B)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "000009 BF 28         23     out TIFR, R18",
        "                     24",
        "                     25 setup_serial:",
        "                     26     ldi R18, high(95)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "00000A B9 22         27     out UBRRH, R18",
        "                     28     ldi R18, low(95)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "00000B B9 29         29     out UBRRL, R18",
        "                     30",
        "00000C B8 0B         31     out UCSRA, R0",
        "                     32",
        "                     33     ldi R18, (1 << TXEN)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "00000D B9 2A         34     out UCSRB, R18",
        "                     35",
        "                     36     ldi R18, (1 << UCSZ0) | (1 << UCSZ1)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "00000E B9 23         37     out UCSRC, R18",
        "                     38",
        "                     39 the_top:",
        ...
        "                     42",
        "                     43 send_digit:",
        "00000F BC 0D         44     out TCNT1H, R0",
        "000010 BC 0C         45     out TCNT1L, R0",
        "                     46",
        "                     47     ldi R18, (1 << OCF1A) | (1 << OCF1B)",
        "                        mnemonic_unknown",
        "                        clue: LDI",
        "000011 BF 28         48     out TIFR, R18",
        "                     49",
        "                     50 wait_for_20ms_interval:",
        "000012 B6 28         51     in R2, TIFR",
        "                     52     sbrs R2, OCF1A",
        "                        mnemonic_unknown",
        "                        clue: SBRS",
        ...
        "                     71",
        "                     72 digits_to_send:",
        '000015 54 65 73 74   73     {{ poke ("Testing1234 "); }}',
        "000017 69 6E 67 31",
        "000019 32 33 34 20",
        "                     74",
        "",
        ...
        "============",
        "",
        "buffer_wait = 20 (1) /var/tmp/demo.asm:64",
        "CS12 = 2 (1) /var/tmp/demo.asm:1",
        "digits_to_send = 21 (0) /var/tmp/demo.asm:72",
        "get_next_char = 19 (0) /var/tmp/demo.asm:55",
        ...
        "wait_for_20ms_interval = 18 (1) /var/tmp/demo.asm:50",
        "write_serial = 19 (0) /var/tmp/demo.asm:60",
        "ZH (1) REGISTER",
        "ZL (1) REGISTER",
    ]);
});
