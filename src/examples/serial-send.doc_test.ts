...
Deno.test("serial-send Demo", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "============",
        "",
        "buffer_wait            | 33 | 21 | /var/tmp/demo.asm:64 | 1",
        "CS12                   | 2  | 2  | /var/tmp/demo.asm:1  | 1",
        "digits_to_send         | 34 | 22 | /var/tmp/demo.asm:72 | 0",
        "get_next_char          | 31 | 1f | /var/tmp/demo.asm:55 | 0",
        ...
        "R18                    |    |    | REGISTER             | 18",
        "R20                    |    |    | REGISTER             | 4",
        "send_digit             | 26 | 1a | /var/tmp/demo.asm:43 | 2",
        "setup_serial           | 15 | f  | /var/tmp/demo.asm:25 | 0",
        "setup_timer            | 4  | 4  | /var/tmp/demo.asm:7  | 0",
        "start_interval_timers  | 11 | b  | /var/tmp/demo.asm:18 | 0",
        ...
        "the_top                | 24 | 18 | /var/tmp/demo.asm:39 | 1",
        ...
        "wait_for_20ms_interval | 30 | 1e | /var/tmp/demo.asm:50 | 1",
        "write_serial           | 32 | 20 | /var/tmp/demo.asm:60 | 0",
        "ZH                     |    |    | REGISTER             | 1",
        "ZL                     |    |    | REGISTER             | 1"
    ]);
});
