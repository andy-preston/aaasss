...
Deno.test("serial-send Demo", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "                     46",
        "                     47 the_top:",
        "000018 E4 E4         48     ldi ZL, low(digits_to_send << 1)",
        ...
        "                        mnemonic_unknown",
        "                        clue: LPM",
        '00001F 32 40         65     cpi R20, " ".charCodeAt(0)',
        "                     66     breq the_top",
        "                        mnemonic_unknown",
        "                        clue: BREQ",
        "                     67",
        "                     68 write_serial:",
        "000020 23 44         69     tst R20",
        "                     70     breq send_digit",
        "                        mnemonic_unknown",
        "                        clue: BREQ",
        "                     71",
        ...
        "                     79",
        "                     80 digits_to_send:",
        '000022 54 65 73 74   81     {{ poke ("Testing1234 "); }}',
        "000024 69 6E 67 31",
        "000026 32 33 34 20",
        "                     82",
        "",
        ...
        "buffer_wait            | 33 | 21 | /var/tmp/demo.asm:72 | 1",
        "CS12                   | 2  | 2  | /var/tmp/demo.asm:1  | 1",
        "digits_to_send         | 34 | 22 | /var/tmp/demo.asm:80 | 0",
        "get_next_char          | 31 | 1f | /var/tmp/demo.asm:63 | 0",
        ...
        "write_serial           | 32 | 20 | /var/tmp/demo.asm:68 | 0",
        "ZH                     |    |    | REGISTER             | 1",
        "ZL                     |    |    | REGISTER             | 1"
    ]);
});
