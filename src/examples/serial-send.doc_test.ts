...
Deno.test("serial-send Demo", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "                     62",
        "                     63 the_top:",
        "000016 E4 EE         64     ldi ZL, low(characters_to_send << 1)",
        ...
        "                        mnemonic_unknown",
        "                        clue: SBIS",
        "000024 CF FF         90     rjmp buffer_wait",
        "                     91",
        "000025 B9 3C         92     out    UDR, R19",
        "                     93",
        "000026 CF F1         94     rjmp send_character",
        "                     95",
        "                     96 characters_to_send:",
        '000027 54 65 73 74   97     {{ poke ("Testing1234 "); }}',
        "000029 69 6E 67 31",
        "00002B 32 33 34 20",
        "                     98",
        "",
        ...
        "characters_to_send     | 39   | 27  | /var/tmp/demo.asm:96 | 0",
