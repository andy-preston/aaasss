...
Deno.test("serial-send Demo", () => {
    ...
    expectFileContents(".lst").toEqual([
        ...
        "                     62",
        "                     63 the_top:",
        "000016 E4 E2         64     ldi ZL, low(characters_to_send << 1)",
        ...
        "                        mnemonic_unknown",
        "                        clue: LPM",
        '00001E 32 30         81     cpi R19, " ".charCodeAt(0)',
        "                     82     breq the_top",
        "                        mnemonic_unknown",
        "                        clue: BREQ",
        "                     83",
        "                     84 write_serial:",
        "00001F 23 33         85     tst R19",
        ...
        '000021 54 65 73 74   97     {{ poke ("Testing1234 "); }}',
        "000023 69 6E 67 31",
        "000025 32 33 34 20",
        "                     98",
        "",
        ...
        "buffer_wait            | 32   | 20  | /var/tmp/demo.asm:88 | 1",
        "characters_to_send     | 33   | 21  | /var/tmp/demo.asm:96 | 0",
        ...
        "write_serial           | 31   | 1F  | /var/tmp/demo.asm:84 | 0",
        "ZH                     |      |     | REGISTER             | 1",
        "ZL                     |      |     | REGISTER             | 1"
    ]);
});
