...
Deno.test("serial-send Demo", () => {
    ...
    assertFileContains(".lst", [
        ...
        "============",
        "",
        "buffer_wait = 0 (1) /var/tmp/demo.asm:64",
        "CS12 = 2 (1)",
        "digits_to_send = 0 (0) /var/tmp/demo.asm:72",
        "get_next_char = 0 (0) /var/tmp/demo.asm:55",
        "OCF1A = 6 (3)",
        "OCF1B = 5 (2)",
        "OCR1AH = 75 (1)",
        "OCR1AL = 74 (1)",
        ...
        "R18 = 18 (18)",
        "R20 = 20 (4)",
        "send_digit = 0 (2) /var/tmp/demo.asm:43",
        "setup_serial = 0 (0) /var/tmp/demo.asm:25",
        "setup_timer = 0 (0) /var/tmp/demo.asm:7",
        "start_interval_timers = 0 (0) /var/tmp/demo.asm:18",
        "TCCR1A = 79 (1)",
        "TCCR1B = 78 (1)",
        "TCNT1H = 77 (2)",
        "TCNT1L = 76 (2)",
        "the_top = 0 (1) /var/tmp/demo.asm:39",
        "TIFR = 88 (3)",
        "TXEN = 3 (1)",
        "UBRRH = 34 (1)",
        "UBRRL = 41 (1)",
        ...
        "UDR = 44 (1)",
        "UDRE = 5 (1)",
        "wait_for_20ms_interval = 0 (1) /var/tmp/demo.asm:50",
        "write_serial = 0 (0) /var/tmp/demo.asm:60",
        "ZH = 31 (1)",
        "ZL = 30 (1)",
    ]);
});
